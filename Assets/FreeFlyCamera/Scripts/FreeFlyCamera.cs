...
public class FreeFlyCamera : MonoBehaviour, IAnchorTargetable
{
    #region UI
    ...
    private void Start()
    {
        ...
        _prevPosition = _initPosition;
        _prevRotation = _initRotation;
    }
    ...
    private void Update()
    {
        ...
        if (_enableMovement)
        {
            ...
            if (OnPositionChanged != null && transform.position != _prevPosition)
            {
        ...
        if (_enableRotation)
        {
            ...
            if(OnRotationChanged != null && transform.eulerAngles != _prevRotation)
            {
                OnRotationChanged?.Invoke(transform.forward);
            }
        }
